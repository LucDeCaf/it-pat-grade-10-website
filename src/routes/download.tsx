...
export default function Download() {
  ...
  return (
    <Container>
      ...
      <br />
      <h3>
        Download Latest Version for <strong>Windows</strong>
      </h3>
      <ul>
        <li>
          <strong>V {versionNumber}:</strong>{' '}
          <a href={`/${latestVersion}.zip`} download>
            {latestVersion}
          </a>
        </li>
      </ul>
      ...
      <ul>
        <li>
          <strong>V 1.1:</strong>{' '}
          <a href='/flashcard-city-v1.1.zip' download>
            flashcard-city-v1.1
          </a>
        </li>
        <li>
          <strong>V 1.0.1:</strong>{' '}
          <a href='/flashcard-city-v1.0.1.zip' download>
            flashcard-city-v1.0.1
          </a>
        </li>
        <li>
          <strong>V 1.0:</strong>{' '}
          <a href='/flashcard-city-v1.0.zip' download>
            flashcard-city-v1.0
          </a>
        </li>
      </ul>
